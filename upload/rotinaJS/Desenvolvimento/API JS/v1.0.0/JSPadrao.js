...
function adicionaErroNovo(config, apply) {
	...
	if (config) {
		var grid = config.grid;
		var campo = config.campo;
		var mensagem = (config.mensagem && config.mensagem != "") ? config.mensagem : "Existem informações obrigatórias que não foram atualizadas!";
		var errorsForm = Form.errors();
